...
const FILE_EXT_MAP = (() => {
  const m = {};
  const add = (cat, exts) => exts.forEach(e => {
    m[e] = cat;
  });
  ...
  add("code", ["js", "mjs", "cjs", "jsx", "ts", "tsx", "py", "pyc", "pyi", "pyw", "java", "class", "kt", "kts", "scala", "groovy", "gradle", "c", "h", "cpp", "cc", "cxx", "hpp", "hh", "hxx", "ino", "cs", "vb", "fs", "fsx", "fsi", "rb", "erb", "rake", "gemspec", "go", "rs", "php", "phtml", "php3", "php4", "php5", "swift", "m", "mm", "lua", "r", "rmd", "jl", "pl", "pm", "t", "sh", "bash", "zsh", "fish", "ksh", "csh", "bat", "cmd", "ps1", "psm1", "dart", "ex", "exs", "erl", "hrl", "elm", "clj", "cljs", "cljc", "edn", "lisp", "lsp", "scm", "rkt", "ml", "mli", "hs", "lhs", "nim", "cr", "zig", "v", "vh", "vhdl", "sv", "svh", "asm", "s"]);
