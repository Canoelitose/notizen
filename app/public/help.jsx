// Help / Anleitung view — comprehensive documentation of all features.

const { useState: useStateH } = React;

function HelpView() {
  // Top-level sections, each with a list of items
  const sections = [
    {
      id: "start", title: "Erste Schritte", icon: "compass",
      items: [
        { h: "Notizen erstellen",
    ...
    {
      id: "views", title: "Sammlungen & Ansichten", icon: "inbox",
      items: [
        { h: "Übersicht",
    ...
    {
      id: "blocks", title: "Block-Editor", icon: "type",
      items: [
        { h: "Was sind Blöcke",
    ...
    {
      id: "links", title: "Verlinkungen", icon: "link",
      items: [
    ...
    {
      id: "due", title: "Fälligkeiten", icon: "flag",
      items: [
        { h: "Datum setzen",
    ...
    {
      id: "tasks", title: "Wiederkehrende Aufgaben", icon: "undo",
      items: [
    ...
    {
      id: "templates", title: "Templates & Variablen", icon: "bookmark",
      items: [
    ...
    {
      id: "export", title: "Export & Drucken", icon: "download",
      items: [
        { h: "Drucken / PDF",
    ...
    {
      id: "spreadsheet", title: "Spreadsheet-Formeln", icon: "table",
      items: [
        { h: "Grundprinzip",
    ...
    {
      id: "ui", title: "Layout & Bedienung", icon: "monitor",
      items: [
    ...
    {
      id: "tweaks", title: "Tweaks", icon: "settings",
      items: [
        { h: "Tweaks öffnen",
    ...
    {
      id: "data", title: "Daten & Speicherung", icon: "database",
      items: [
  ...
  return (
    <section className="help-view">
      <div className="help-head">
        <h1>Anleitung</h1>
        <div className="help-sub">Alle Funktionen erklärt — von den Grundlagen bis zu den Spreadsheet-Formeln.</div>
      </div>

      <nav className="help-toc">
        {sections.map(s => (
          <a key={s.id} href={`#help-${s.id}`} className="help-toc-item">
      ...
      <div className="help-content">
        {sections.map(s => (
          <section key={s.id} id={`help-${s.id}`} className="help-section">
            <h2><Icon name={s.icon} size={16} /> {s.title}</h2>
        ...
        <div className="help-foot">
          ...
          <span>Viel Erfolg mit deinen Notizen!</span>
        </div>
      </div>
    </section>
  );
