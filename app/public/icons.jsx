// Lightweight inline SVG icons. Stroke-based, 16px default.
const Icon = ({ name, size = 16, className = "", style = {} }) => {
  ...
  switch (name) {
    ...
    case "folder-open": return <svg {...props}><path d="M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v.5"/><path d="m3 10 1.6 7.2A2 2 0 0 0 6.55 19h11.9a2 2 0 0 0 1.95-1.6L22 10H3Z"/></svg>;
    ...
    case "star-fill": return <svg {...props} fill="currentColor" stroke="none"><path d="m12 2 3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2Z"/></svg>;
    ...
    case "terminal": return <svg {...props}><path d="m4 7 4 4-4 4M11 15h8"/><rect x="2" y="3" width="20" height="18" rx="2"/></svg>;
    ...
    case "tag": return <svg {...props}><path d="M20.59 13.41 13.42 20.6a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82Z"/><circle cx="7" cy="7" r="1" fill="currentColor"/></svg>;
    ...
    case "check-square": return <svg {...props}><path d="M9 11l3 3 8-8"/><path d="M20 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h11"/></svg>;
    ...
    case "heading": return <svg {...props}><path d="M6 4v16M18 4v16M6 12h12"/></svg>;
    ...
    case "settings": return <svg {...props}><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1Z"/></svg>;
    case "pin": return <svg {...props}><path d="M12 17v5M9 10.76a2 2 0 0 1-1.11 1.79l-1.78.9A2 2 0 0 0 5 15.24V16a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-.76a2 2 0 0 0-1.11-1.79l-1.78-.9A2 2 0 0 1 15 10.76V7a1 1 0 0 1 1-1 2 2 0 0 0 0-4H8a2 2 0 0 0 0 4 1 1 0 0 1 1 1v3.76Z"/></svg>;
    case "home": return <svg {...props}><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2h-4v-7h-6v7H5a2 2 0 0 1-2-2Z"/></svg>;
    case "server": return <svg {...props}><rect x="2" y="3" width="20" height="8" rx="2"/><rect x="2" y="13" width="20" height="8" rx="2"/><path d="M6 7h.01M6 17h.01"/></svg>;
    ...
    case "cloud": return <svg {...props}><path d="M17.5 19a4.5 4.5 0 1 0-.8-8.93 6 6 0 0 0-11.7 1.93 4 4 0 0 0 .5 7Z"/></svg>;
    case "key": return <svg {...props}><circle cx="7.5" cy="15.5" r="3.5"/><path d="m21 2-9.6 9.6M15.5 7.5l3 3 3-3-3-3Z"/></svg>;
    case "lock": return <svg {...props}><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>;
    case "unlock": return <svg {...props}><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 9.9-1"/></svg>;
    case "bell": return <svg {...props}><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9M13.7 21a2 2 0 0 1-3.4 0"/></svg>;
    ...
    case "package": return <svg {...props}><path d="M16.5 9.4 7.55 4.24M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.27 6.96 8.73 5.05 8.73-5.05M12 22.08V12"/></svg>;
    ...
    case "flag": return <svg {...props}><path d="M4 22V4a1 1 0 0 1 .4-.8 6 6 0 0 1 7.2 0 6 6 0 0 0 7.2 0 1 1 0 0 1 1.2 1V15a1 1 0 0 1-.4.8 6 6 0 0 1-7.2 0 6 6 0 0 0-7.2 0"/></svg>;
    ...
    case "archive": return <svg {...props}><rect x="2" y="3" width="20" height="5" rx="1"/><path d="M4 8v11a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8M10 12h4"/></svg>;
    ...
    case "compass": return <svg {...props}><circle cx="12" cy="12" r="10"/><path d="m16.24 7.76-2.83 5.66-5.66 2.83 2.83-5.66Z"/></svg>;
    case "wrench": return <svg {...props}><path d="M14.7 6.3a4 4 0 0 0-5.66 5.66l-6.34 6.34a1 1 0 0 0 0 1.41l1.59 1.59a1 1 0 0 0 1.41 0l6.34-6.34a4 4 0 0 0 5.66-5.66l-2.83 2.83-2.83-2.83Z"/></svg>;
